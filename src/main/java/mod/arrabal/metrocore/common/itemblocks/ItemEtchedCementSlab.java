...
import mod.arrabal.metrocore.common.block.BlockDoubleEtchedCementSlab;
import mod.arrabal.metrocore.common.block.BlockHalfEtchedCementSlab;
import mod.arrabal.metrocore.common.block.BlockEtchedCementSlab;
...
/**
 * Created by Evan on 1/16/2015.
 */
public class ItemEtchedCementSlab extends ItemBlockMetroCoreWithVariants {

    private final BlockEtchedCementSlab singleSlab;
    private final BlockEtchedCementSlab doubleSlab;

    public ItemEtchedCementSlab(Block block, BlockHalfEtchedCementSlab singleSlab, BlockDoubleEtchedCementSlab doubleSlab){
        super(block);
