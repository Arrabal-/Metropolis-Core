...
public abstract class BlockPolishedCementSlab extends BlockMetroCoreSlab {
    ...
    protected BlockPolishedCementSlab(){
        super(Material.rock);
    ...
    public Item getItemDropped(IBlockState state, Random random, int fortune){
        return Item.getItemFromBlock(ModBlocks.blockPolishedCementSlab);
    }
    ...
    public String getUnlocalizedName(int meta) {
        ...
        return super.getUnlocalizedName(meta) + "." + BlockPolishedCementSlab.CementSlabType.byMetadata(meta).getUnlocalizedName();
    }
    ...
    public Object getVariant(ItemStack stack) {
        return BlockPolishedCementSlab.CementSlabType.byMetadata(stack.getMetadata() & 7);
    }

    @Override
    public void getSubBlocks(Item item, CreativeTabs creativeTab, List list){
        if (item != Item.getItemFromBlock(ModBlocks.blockDoublePolishedCementSlab)){
            BlockPolishedCementSlab.CementSlabType[] types =  BlockPolishedCementSlab.CementSlabType.values();
            int typeCount = types.length;
            for (int i = 0; i < typeCount; ++i){
                BlockPolishedCementSlab.CementSlabType type = types[i];
    ...
    public int getMetaFromState(IBlockState state){
        byte b = 0;
        int meta = b | ((BlockPolishedCementSlab.CementSlabType)state.getValue(VARIANT)).getMetadata();
        if (this.isDouble()) {
    ...
    public static enum CementSlabType implements IStringSerializable {
        ...
        private static final BlockPolishedCementSlab.CementSlabType[] META_LOOKUP = new BlockPolishedCementSlab.CementSlabType[values().length];
        ...
        public static BlockPolishedCementSlab.CementSlabType byMetadata(int meta){
        ...
        static{
            BlockPolishedCementSlab.CementSlabType[] types = values();
            int typeNum = types.length;

            for (int i = 0; i < typeNum; ++i){
                BlockPolishedCementSlab.CementSlabType variant = types[i];
